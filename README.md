...
You will also need the `guppy` basecaller from Oxford Nanopore. It can be downloaded from their [community site](https://community.nanoporetech.com/downloads).
